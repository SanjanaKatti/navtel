      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start mb-16 gap-8">
            ...
            <h2 className="text-h1">
              Telematics hardware.<br/>Reliable. Integrable.<br/>Scalable.
            </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="row-span-2 bg-[#F1F5F9] p-10 flex flex-col justify-between transition-all hover:shadow-lg border border-gray-200 rounded-2xl group">
             <div>
                <span className="text-h3 text-gray-400 block mb-6">{tools[0].number}</span>
          ...
          {tools.slice(1).map((tool, idx) => (
            <div key={idx} className="bg-[#1E293B] p-10 flex flex-col justify-between h-[280px] transition-all hover:shadow-lg hover:bg-[#0F172A] border border-gray-800 rounded-2xl group">
               <div>
                  <span className="text-h3 text-gray-500 block mb-6">{tool.number}</span>
