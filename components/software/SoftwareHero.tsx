...
const SoftwareHero: React.FC<SoftwareHeroProps> = ({
  ...
  return (
    <section
      className={`relative flex items-center overflow-hidden ${bgCls} py-10 sm:py-14 md:py-16 lg:min-h-[calc(100dvh-5rem)] lg:h-[calc(100vh-5rem)] lg:py-0`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full lg:py-16 xl:py-24">
        <div
          className={`grid lg:grid-cols-1 gap-10 sm:gap-14 lg:gap-20 items-center ${center ? "justify-items-center" : ""}`}
        >
          <div
          ...
          >
            ...
            <div className={center ? "max-lg:w-full max-lg:px-1" : ""}>
              <h1
            ...
            {(ctaPrimary || ctaSecondary) && (
              <div
                className={`flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-2 sm:pt-4 w-full ${center ? "lg:justify-center max-lg:items-center max-lg:max-w-md" : "max-lg:max-w-xl"}`}
              >
                {ctaPrimary &&
                  (ctaPrimary.href ? (
                    <Link
                      ...
                      className={
                        ctaPrimary.variant === "secondary"
                          ? "text-center bg-white text-brand-navy px-6 py-4 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-2xl font-bold text-base sm:text-lg border-2 border-gray-100 hover:border-brand-deep transition-all max-lg:w-full max-lg:shadow-lg lg:w-auto"
                          : "text-center bg-[#002D49] text-white px-6 py-4 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-2xl font-black text-base sm:text-lg hover:bg-brand-deep transition-all shadow-xl hover:shadow-2xl max-lg:w-full max-lg:shadow-[0_4px_24px_rgba(0,45,73,0.35)] lg:w-auto"
                      }
                    >
                      {ctaPrimary.label}
                    </Link>
                    ...
                    <button
                      ...
                      className="bg-[#002D49] text-white px-6 py-4 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-2xl font-black text-base sm:text-lg hover:bg-brand-deep transition-all shadow-xl hover:shadow-2xl max-lg:w-full max-lg:shadow-[0_4px_24px_rgba(0,45,73,0.35)] lg:w-auto"
                    >
                      {ctaPrimary.label}
                    </button>
                  ))}
                {ctaSecondary &&
                  (ctaSecondary.href ? (
                    <Link
                      ...
                      className="text-center bg-white text-brand-navy px-6 py-4 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-2xl font-bold text-base sm:text-lg border-2 border-gray-100 hover:border-brand-deep transition-all max-lg:w-full max-lg:shadow-lg lg:w-auto"
                    >
                      {ctaSecondary.label}
                    </Link>
                  ) : (
                    <button
                      ...
                      className="bg-white text-brand-navy px-6 py-4 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-2xl font-bold text-base sm:text-lg border-2 border-gray-100 hover:border-brand-deep transition-all max-lg:w-full max-lg:shadow-lg lg:w-auto"
                    >
                      {ctaSecondary.label}
                    </button>
                  ))}
