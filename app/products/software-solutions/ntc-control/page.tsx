  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased text-brand-navy">
      ...
      <main className="pt-20">
        <section className="relative h-[calc(100vh-5rem)] min-h-[calc(100dvh-5rem)] flex items-center overflow-hidden bg-white product-background-image ntc-control-hero-background">
