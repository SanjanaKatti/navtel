          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto font-medium">
                Comprehensive cloud-based platform for remote device management, monitoring, and diagnostics.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white p-12 border border-gray-200">
              ...
              <div className="space-y-6">
                <div className="p-6 bg-[#F8FAFC] border border-gray-200">
                  <h3 className="text-xl font-bold text-[#00529B] mb-3">Remote Management</h3>
                  <p className="text-gray-600">Manage and configure devices remotely from anywhere.</p>
                </div>
                <div className="p-6 bg-[#F8FAFC] border border-gray-200">
                  <h3 className="text-xl font-bold text-[#00529B] mb-3">Real-time Monitoring</h3>
                  <p className="text-gray-600">Monitor device status and performance in real-time.</p>
                </div>
                <div className="p-6 bg-[#F8FAFC] border border-gray-200">
                  <h3 className="text-xl font-bold text-[#00529B] mb-3">Diagnostics</h3>
                  <p className="text-gray-600">Advanced diagnostics and troubleshooting tools.</p>
                </div>
              </div>
            </div>
          </div>
