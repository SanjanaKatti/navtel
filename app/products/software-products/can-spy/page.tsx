          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto font-medium">
                Advanced tool for scanning, analyzing, and decoding CAN bus data from vehicles.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white p-12 border border-gray-200">
              ...
              <div className="space-y-6">
                <div className="p-6 bg-[#F8FAFC] border border-gray-200">
                  <h3 className="text-xl font-bold text-[#00529B] mb-3">CAN Bus Scanning</h3>
                  <p className="text-gray-600">Scan and identify CAN bus messages and protocols.</p>
                </div>
                <div className="p-6 bg-[#F8FAFC] border border-gray-200">
                  <h3 className="text-xl font-bold text-[#00529B] mb-3">Data Decoding</h3>
                  <p className="text-gray-600">Decode vehicle-specific data formats and parameters.</p>
                </div>
                <div className="p-6 bg-[#F8FAFC] border border-gray-200">
                  <h3 className="text-xl font-bold text-[#00529B] mb-3">Protocol Support</h3>
                  <p className="text-gray-600">Support for multiple vehicle manufacturers and protocols.</p>
                </div>
              </div>
            </div>
          </div>
