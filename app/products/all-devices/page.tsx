...
const AllDevicesPage = () => {
  ...
  const allDevices: Device[] = [
    // START Series (Basic)
    { 
      name: "S-2010", category: "Basic", series: "START", connectivity: "2G", sim: "Single SIM",
      interfaces: ["USB Type-C"], bluetooth: "Bluetooth 4.0", inputs: "4 Digital IN & 1 Analog IN",
      outputs: "1 OUT", antennas: "Internal", battery: "—", href: "/products/tracking-devices/start-series/s-2010"
    },
    { 
      name: "S-2011", category: "Basic", series: "START", connectivity: "2G", sim: "Single SIM",
      interfaces: ["USB Type-C"], bluetooth: "Bluetooth 4.0", inputs: "4 Digital IN & 1 Analog IN",
      outputs: "1 OUT", antennas: "Internal", battery: "130 mAh", href: "/products/tracking-devices/start-series/s-2011"
    },
    { 
      name: "S-2013", category: "Basic", series: "START", connectivity: "2G", sim: "Single SIM",
      interfaces: ["RS-485", "USB Type-C"], bluetooth: "Bluetooth 4.0", inputs: "2 Digital IN & 1 Analog IN",
      outputs: "1 OUT", antennas: "Internal", battery: "130 mAh", href: "/products/tracking-devices/start-series/s-2013"
    },
    { 
      name: "S-4011", category: "Basic", series: "START", connectivity: "4G / 2G", sim: "Single SIM",
      interfaces: ["USB Type-C"], bluetooth: "Bluetooth 4.0", inputs: "4 Digital IN & 1 Analog IN",
      outputs: "1 OUT", antennas: "Internal", battery: "130 mAh", href: "/products/tracking-devices/start-series/s-4011"
    },
    { 
      name: "S-4013", category: "Basic", series: "START", connectivity: "4G / 2G", sim: "Single SIM",
      interfaces: ["RS-485", "USB Type-C"], bluetooth: "Bluetooth 4.0", inputs: "2 Digital IN & 1 Analog IN",
      outputs: "1 OUT", antennas: "Internal", battery: "130 mAh", href: "/products/tracking-devices/start-series/s-4013"
    },
    // SMART Series (Advanced)
    { 
      name: "S-2437", category: "Advanced", series: "SMART", connectivity: "2G", sim: "Dual SIM",
      interfaces: ["RS-485", "1-Wire", "MODBUS", "Dual CAN"], bluetooth: "Bluetooth 4.0", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "800 mAh",
      href: "/products/tracking-devices/smart-series/s-2437"
    },
    { 
      name: "S-2435", category: "Advanced", series: "SMART", connectivity: "2G", sim: "Dual SIM",
      interfaces: ["RS-485", "RS-232", "1-Wire", "MODBUS", "CAN"], bluetooth: "Bluetooth 4.0", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "800 mAh",
      href: "/products/tracking-devices/smart-series/s-2435"
    },
    { 
      name: "S-2433", category: "Advanced", series: "SMART", connectivity: "2G", sim: "Single SIM",
      interfaces: ["RS-485", "RS-232", "1-Wire", "MODBUS"], bluetooth: "Bluetooth 4.0", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "800 mAh",
      href: "/products/tracking-devices/smart-series/s-2433"
    },
    { 
      name: "S-2425", category: "Advanced", series: "SMART", connectivity: "2G", sim: "Dual SIM",
      interfaces: ["RS-485", "RS-232", "1-Wire"], bluetooth: "Bluetooth 4.0", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "380 mAh",
      href: "/products/tracking-devices/smart-series/s-2425"
    },
    { 
      name: "S-2423", category: "Advanced", series: "SMART", connectivity: "2G", sim: "Single SIM",
      interfaces: ["RS-485", "1-Wire"], bluetooth: "Bluetooth 4.0", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "380 mAh",
      href: "/products/tracking-devices/smart-series/s-2423"
    },
    { 
      name: "S-4513", category: "Advanced", series: "SMART", connectivity: "4G / 2G", sim: "Dual SIM",
      interfaces: ["RS-485", "1-Wire", "MODBUS"], bluetooth: "Bluetooth 4.0 (v5.0 compatible)", 
      inputs: "4 Digital IN & 1 Analog IN", outputs: "2 OUT", antennas: "Internal", battery: "380 mAh",
      href: "/products/tracking-devices/smart-series/s-4513"
    },
    { 
      name: "S-4511", category: "Advanced", series: "SMART", connectivity: "4G / 2G", sim: "Single SIM",
      interfaces: [], bluetooth: "Bluetooth 4.0 (v5.0 compatible)", 
      inputs: "4 Digital IN & 1 Analog IN", outputs: "2 OUT", antennas: "Internal", battery: "380 mAh",
      href: "/products/tracking-devices/smart-series/s-4511"
    },
    { 
      name: "S-4537", category: "Advanced", series: "SMART", connectivity: "4G / 2G", sim: "Dual SIM",
      interfaces: ["RS-485", "1-Wire", "MODBUS", "Dual CAN"], bluetooth: "Bluetooth 4.0 (v5.0 compatible)", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "800 mAh",
      href: "/products/tracking-devices/smart-series/s-4537"
    },
    { 
      name: "S-4535", category: "Advanced", series: "SMART", connectivity: "4G / 2G", sim: "Dual SIM",
      interfaces: ["RS-485", "RS-232", "1-Wire", "MODBUS", "CAN"], bluetooth: "Bluetooth 4.0 (v5.0 compatible)", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "800 mAh",
      href: "/products/tracking-devices/smart-series/s-4535"
    },
    { 
      name: "S-4533", category: "Advanced", series: "SMART", connectivity: "4G / 2G", sim: "Dual SIM",
      interfaces: ["RS-485", "RS-232", "1-Wire", "MODBUS"], bluetooth: "Bluetooth 4.0 (v5.0 compatible)", 
      inputs: "3 Universal IN", outputs: "2 OUT", antennas: "Internal", battery: "800 mAh",
      href: "/products/tracking-devices/smart-series/s-4533"
    },
    // SIGNAL Series (Professional)
    { 
      name: "S-2653", category: "Professional", series: "SIGNAL", connectivity: "2G", sim: "Dual SIM",
      interfaces: ["RS-485", "1-Wire", "MODBUS", "Dual CAN"], bluetooth: "Bluetooth 4.0", 
      inputs: "6 Universal IN", outputs: "4 OUT", antennas: "External", battery: "800 mAh",
      href: "/products/tracking-devices/signal-series/s-2653"
    },
    { 
      name: "S-2613", category: "Professional", series: "SIGNAL", connectivity: "2G", sim: "Single SIM",
      interfaces: ["RS-485"], bluetooth: "Bluetooth 4.0", 
      inputs: "4 Digital IN & 1 Analog IN", outputs: "4 OUT", antennas: "External", battery: "800 mAh",
      href: "/products/tracking-devices/signal-series/s-2613"
    },
    { 
      name: "S-2651", category: "Professional", series: "SIGNAL", connectivity: "2G", sim: "Dual SIM",
      interfaces: ["RS-485", "RS-232", "1-Wire", "MODBUS", "CAN"], bluetooth: "Bluetooth 4.0", 
      inputs: "6 Universal IN", outputs: "4 OUT", antennas: "External", battery: "800 mAh",
      href: "/products/tracking-devices/signal-series/s-2651"
    },
    { 
      name: "S-4753", category: "Professional", series: "SIGNAL", connectivity: "4G / 2G", sim: "Dual SIM",
      interfaces: ["RS-485", "1-Wire", "MODBUS", "Dual CAN"], bluetooth: "Bluetooth 4.0 (v5.0 compatible)", 
      inputs: "6 Universal IN", outputs: "4 OUT", antennas: "External", battery: "800 mAh",
      href: "/products/tracking-devices/signal-series/s-4753"
    },
    { 
      name: "S-4751", category: "Professional", series: "SIGNAL", connectivity: "4G / 2G", sim: "Dual SIM",
      interfaces: ["RS-485", "RS-232", "1-Wire", "MODBUS", "CAN"], bluetooth: "Bluetooth 4.0 (v5.0 compatible)", 
      inputs: "6 Universal IN", outputs: "4 OUT", antennas: "External", battery: "800 mAh",
  ...
  const filterOptions = {
    ...
    bluetooth: ["Bluetooth 4.0", "Bluetooth 4.0 (v5.0 compatible)", "Bluetooth 5.0"],
    inputs: ["2 Digital IN & 1 Analog IN", "4 Digital IN & 1 Analog IN", "3 Universal IN", "6 Universal IN"],
  ...
  const filteredDevices = allDevices.filter(device => {
    const seriesMatch = quickSeries === "all" || device.series.toLowerCase() === quickSeries;
    const networkMatch = quickNetwork === "all" || (quickNetwork === "2g" ? device.connectivity === "2G" : device.connectivity === "4G / 2G");
    
    return (
      seriesMatch &&
      networkMatch &&
      (filters.category.length === 0 || filters.category.includes(device.category)) &&
      (filters.sim.length === 0 || filters.sim.includes(device.sim)) &&
      (filters.interfaces.length === 0 || filters.interfaces.some(i => device.interfaces.includes(i))) &&
      (filters.bluetooth.length === 0 || filters.bluetooth.includes(device.bluetooth)) &&
      (filters.inputs.length === 0 || filters.inputs.includes(device.inputs)) &&
      (filters.outputs.length === 0 || filters.outputs.includes(device.outputs)) &&
      (filters.antennas.length === 0 || filters.antennas.includes(device.antennas)) &&
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans antialiased text-brand-navy">
        ...
        <section className="h-[calc(100vh-5rem)] min-h-[calc(100dvh-5rem)] flex items-center py-12 md:py-16 bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-body-lg max-w-2xl mx-auto">
              Filter through our entire range of START, SMART, and SIGNAL series trackers to find the perfect fit for your project.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-center gap-8">
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-black uppercase tracking-widest text-gray-400">Series:</span>
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-black uppercase tracking-widest text-gray-400">Network:</span>
                <div className="flex bg-white p-1 rounded-xl border border-gray-200 shadow-sm">
                  {["all", "2g", "4g"].map((n) => (
                    <button
                      key={n}
              ...
              <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm sticky top-28">
                <div className="flex items-center justify-between mb-8">
                  <h2 className="text-h3 flex items-center gap-2">
                    <Funnel size={20} weight="bold" className="text-brand-primary" />
                    Filters
                  </h2>
                  <button 
                    onClick={() => {
                      setFilters({
                        category: [], sim: [], interfaces: [], bluetooth: [], 
                        inputs: [], outputs: [], antennas: [], battery: []
                      });
                      setQuickSeries("all");
                      setQuickNetwork("all");
                    }}
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-8">
                <p className="text-body-sm font-bold text-gray-400">
                  SHOWING <span className="text-brand-navy">{filteredDevices.length}</span> DEVICES
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredDevices.map((device, idx) => (
                  ...
                  >
                    <div className="p-8 pb-0 flex flex-col items-start">
                      {/* Compare Checkbox */}
                      <div className="absolute top-6 right-6 z-10">
                        ...
                        >
                          {selectedDevices.some(d => d.name === device.name) && <Check size={16} weight="bold" />}
                        </button>
                      </div>
                      ...
                      <div className="space-y-3 mb-8 w-full">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-caption text-gray-500">{device.connectivity}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-brand-primary"></div>
                          <span className="text-caption text-gray-500">{device.sim}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-brand-primary"></div>
                          <span className="text-caption text-gray-500 line-clamp-1">{device.inputs}</span>
                        </div>
                      </div>
                    </div>

                    <div className="p-8 pt-0 mt-auto">
                      <Link href={device.href} className="w-full bg-brand-navy text-white py-4 rounded-xl font-black text-xs hover:bg-brand-primary transition-all text-center block uppercase tracking-widest">
                        View Specifications
                      </Link>
                    </div>
                  </div>
              ...
              {filteredDevices.length === 0 && (
                <div className="text-center py-20 bg-white rounded-[3rem] border border-dashed border-gray-200">
                  <Funnel size={48} weight="light" className="mx-auto text-gray-200 mb-4" />
                  <p className="text-body-lg text-gray-400">No devices match your selected filters.</p>
                  <button 
                    onClick={() => {
                      setFilters({
                        category: [], sim: [], interfaces: [], bluetooth: [], 
      ...
      {isFilterOpen && (
        <div className="fixed inset-0 z-[100] lg:hidden">
          <div className="absolute inset-0 bg-brand-navy/80 backdrop-blur-sm" onClick={() => setIsFilterOpen(false)}></div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {selectedDevices.length < 4 && (
                <span className="text-body-sm text-gray-400">Select up to {4 - selectedDevices.length} more</span>
              )}
            </div>
            <Link 
