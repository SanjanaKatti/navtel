            ...
            features={[
              {
                ...
                icon: <ArrowsLeftRight size={40} weight="light" />,
              },
              {
                title: "BLE Available",
        ...
        <ProductCenter
          ...
          products={[
            ...
            },
            {
              ...
              specs: [],
              buttonText: "Explore",
              href: "https://wiki.navtelecom.ru/en/home/devices/s4011",
            },
            {
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-body text-center">
              Have questions about S-4011 or 4G connectivity? Please visit our{" "}
              <a
                href="/support/faq"
