            ...
            <div className="space-y-8 ml-0 lg:ml-10">
              ...
              <div className="space-y-4 max-w-sm">
                <p className="text-body-lg">
                  Advanced GPS tracking devices. Designed for fleets, transport
      ...
      <TechnicalSpecs
        groups={[
          ...
          },
          {
            ...
            items: [{ label: "Data Storage", value: "up to 100,000 records" }],
          },
          {
        ...
        products={[
          {
            ...
            specs: [],
            buttonText: "Download",
            href: "https://drive.google.com/uc?export=download&id=1Qpcet3z2HykdX_K2KG0V7CGgLqUhx9pt",
          },
          {
            name: "Knowledge Base",
            ...
            specs: [],
            buttonText: "Explore",
            href: "https://wiki.navtelecom.ru/en/home/devices/s4537",
          },
          {
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-body text-center">
            For questions about S-4537, visit our{" "}
            <a
              href="/support/faq"
