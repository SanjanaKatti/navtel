        ...
        <TechnicalSpecs
          groups={[
            ...
            },
            {
              ...
              items: [{ label: "Data Storage", value: "up to 51,500 records" }],
            },
            {
          ...
          products={[
            {
              ...
              specs: [],
              buttonText: "Download",
              href: "https://drive.google.com/uc?export=download&id=1uQyPQ5vZ2Clkf0Fv6-2iZjmAWW4tArfN",
            },
            {
              name: "Knowledge Base",
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-body text-center">
              For questions about S-2437 and other Smart series devices, please
              visit our{" "}
              <a
                href="/support/faq"
