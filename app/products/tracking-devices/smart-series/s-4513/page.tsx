...
import { Bluetooth, GlobeSimple, Code, Cpu } from "phosphor-react";
              ...
              <div className="space-y-8 ml-0 lg:ml-10">
                ...
                <div className="space-y-4 max-w-sm">
                  <p className="text-body-lg">
                    ...
                    Reliable solution for fleet operations and transport
                    automation.
                  </p>
                </div>
                <button
            ...
            groups={[
              ...
              },
              {
                ...
                items: [
                  ...
                  {
                    label: "Average Current Consumption (12 V)",
                    value: "75 mA",
                  },
                  {
              ...
              },
              {
                ...
                items: [
                  ...
                  { label: "SIM Slots", value: "2" },
                  {
                    label: "SIM Type",
                    value:
                      "Slot 1: External, mini-SIM; Slot 2: Internal, nano-SIM",
                  },
                ],
              },
              {
            ...
            products={[
              {
                ...
                specs: [],
                buttonText: "Download",
                href: "https://drive.google.com/uc?export=download&id=1_2q2vysioxX7so5TbsRYza-JEbkkCuXb",
              },
              {
                name: "Knowledge Base",
                ...
                specs: [],
                buttonText: "Explore",
                href: "https://wiki.navtelecom.ru/en/home/devices/s4513",
              },
              {
          ...
          <section className="py-12 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <p className="text-body text-center">
                For questions about S-4513, visit our{" "}
                <a
                  href="/support/faq"
