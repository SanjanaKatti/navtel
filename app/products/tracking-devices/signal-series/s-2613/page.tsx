...
import { Bluetooth, GlobeSimple, Code } from "phosphor-react";
            ...
            <div className="space-y-8 ml-0 lg:ml-10">
              ...
              <div className="space-y-4 max-w-sm">
                <p className="text-body-lg">
                  Basic tracking and control solution for transport, fleets, and
      ...
      <div ref={featuresRef}>
        ...
        features={[
          ...
          },
          {
            ...
            sub: "Control. Remotely.",
            desc: "Four digital outputs for remote control applications.",
            icon: (
              <svg
                viewBox="0 0 24 24"
                fill="none"
        ...
        products={[
          {
            ...
            specs: [],
            buttonText: "Download",
            href: "https://drive.google.com/uc?export=download&id=11zCgVwD7noOwNpRgzXjGjhRcgjDnNlZs",
          },
          {
            name: "Knowledge Base",
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-body text-center">
            For questions about S-2613, visit our{" "}
            <a
              href="/support/faq"
