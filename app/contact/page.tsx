  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased text-brand-navy overflow-x-hidden">
      ...
      <main className="pt-20">
        <section className="h-[calc(100vh-5rem)] min-h-[calc(100dvh-5rem)] flex items-center bg-brand-light-3">
              ...
              <div className="space-y-12 lg:pt-4">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-12">
                  ...
                  <div className="space-y-5 group">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="text-h2 text-brand-navy group-hover:text-brand-primary transition-colors">
                        India Office
                      </h2>
                    </div>
                    <p className="text-body text-gray-500 leading-relaxed max-w-sm">
                      Our India team is ready to support you with product
                      details, technical assistance, or partnership inquiries.
                    </p>
                    <div className="space-y-4 pt-2">
                      ...
                      <div className="flex items-start gap-4 text-body text-gray-500">
                        ...
                        <p className="pt-1">
                          ...
                          <br />
                          Spaze I-Tech Park, Tower B4, Unit 408,
                          <br />
                  ...
                  <div className="space-y-5 group">
                    ...
                    <p className="text-body text-gray-500 leading-relaxed max-w-sm">
                      For clients and distributors across the Middle East
                      region, please contact our UAE branch.
                    </p>
                    <div className="space-y-4 pt-2">
                      <div className="flex items-center gap-4 text-body font-bold text-brand-navy">
                        <div className="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center text-brand-primary border border-gray-100">
                ...
                <div className="pt-8 border-t border-brand-navy/5">
                  ...
                  <div className="flex gap-4">
                    <a
                      href="#"
                      className="w-12 h-12 bg-brand-navy text-white rounded-xl flex items-center justify-center hover:bg-brand-primary transition-all transform hover:-translate-y-1 shadow-lg shadow-brand-navy/10"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                    ...
                    <a
                      href="#"
                      className="w-12 h-12 bg-white border-2 border-gray-100 text-brand-primary rounded-xl flex items-center justify-center hover:border-brand-primary transition-all transform hover:-translate-y-1 shadow-sm"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="none"
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="name" className="text-label ml-1">
                        Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="email" className="text-label ml-1">
                        Email
                      </label>
                      <input
                        type="email"
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="company" className="text-label ml-1">
                        Name of the Company
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="mobile" className="text-label ml-1">
                        Mobile Number
                      </label>
                      <input
                        type="tel"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="country" className="text-label ml-1">
                      Country
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-label ml-1">
                      Message
                    </label>
                    <textarea
                      id="message"
